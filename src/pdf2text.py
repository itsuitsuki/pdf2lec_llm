...
def generate_lecture_from_images_openai(client, image_dir, prompt, context_size=2, model_name="gpt-4o", max_tokens=500, multiagent=False):
    """
    ...
    # use multiple agents to refine the content
    if multiagent:
        refined_contents = multiagent_generation(client, contents, model_name=model_name)
        return refined_contents, image_files
